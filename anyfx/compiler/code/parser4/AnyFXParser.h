...
public:
  ...
  explicit AnyFXParser(antlr4::TokenStream *input);

  AnyFXParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~AnyFXParser() override;
